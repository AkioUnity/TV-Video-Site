...
<div class="row">
	<div class="col-md-9">
        <h3 class="block-title3 mv5 mvt0" data-title="<?=$channel_data->name?>"><?=$set_data->name?></h3>
    </div>
    <div class="col-md-3">
        <a href="<?=site_url($_cancel.'/'.$channel_data->channel_url.'/all?category='.url_title(strtolower($set_data->name)));?>" class="category-more text-left">View All <img src="assets/frontends/images/arrow-right-red.png" alt="Arrow"></a>
    </div>
    <div class="col-md-12">
        <div class="row">
            <div class="col-md-12">
...
<div class="image video-frame" data-src="<?=$image?>" style="background-image: url('<?=$image?>');">
<img src="assets/frontends/images/1x1.png" alt="Proportion">
<a class="video-player video-player-small video-player-inside" href="<?=$set_product->video_link?>"></a>
</div>
</div>
</div>
<?php
...
<div class="col-xs-6 col-sm-6 col-md-3">
<div class="post hover-light">
<div class="image video-frame" data-src="<?=$image?>" style="background-image: url(&quot;assets/frontends/images/news/video-small-07.jpg&quot;);">
<img src="assets/frontends/images/1x1.png" alt="Proportion">
<a class="video-player video-player-small video-player-inside" href="https://www.youtube.com/watch?v=Jyohsf0zPdA"></a>
</div>
</div>
</div>
