...
<div class="post first text-bigger hover-dark entry-media">
    <div class="image video-frame">
        <img src="<?=!empty($article_img)?$article_img:'assets/uploads/no-image.gif'?>" alt="Post image"/>
        <a class="video-player video-player-center video-player-large" href="<?=$news_details->v_link?>"></a>
    </div>
</div>
...
<div class="post first text-bigger hover-dark entry-media">
    <div class="image video-frame">
        <img src="<?=!empty($article_img)?$article_img:'assets/uploads/no-image.gif'?>" alt="Post image"/>
        <a class="video-player video-player-center video-player-large" href="assets/uploads/news/<?=$news_details->video_file?>"></a>
    </div>
</div>
<!-- /End Video or Photo Placeholder -->
<?php
...
if($article_author){
?>
<img src="<?=!empty($article_author->image)?'assets/uploads/news/thumbnails/'.$article_author->image:'assets/uploads/profile.jpg'?>" style="border-radius: 50%; width: 100px; height: 100px;">
<?php
}
?>
...
<!-- /End Article Views -->            
        ...
        <a class="btn btn-social-icon btn-facebook" onClick="window.open('http://www.facebook.com/sharer.php?u=<?php echo site_url(uri_string())?>&amp;t=<?php echo urlencode($news_details->name)?>', 'facebookShare', 'width=626,height=436'); return false;"><i class="fa fa-facebook"></i></a>
        ...
        <a class="btn btn-social-icon btn-twitter" onClick="window.open('http://twitter.com/share?text=<?php echo urlencode($news_details->name)?>&amp;url=<?php echo site_url(uri_string())?>', 'twitterShare', 'width=626,height=436'); return false;"><i class="fa fa-twitter"></i></a>
...
<?php /*?>		<div class="meta">
		...
		<h4><a href="news/v/<?=$set_news->id?>"><?=$set_news->name?> - <?=print_value('authors',array('id'=>$set_news->author_id),'name')?></a></h4>
		<p><?=$new_html?>...</p>
	</div>
</li>
<?php		
...
<div class="section-full pv9 pvb0">
	<div class="container">
        <div class="row">
            ...
            <div class="fs-pager">
            <span>
            <a href="single.html" class="fs-arrow-prev swiper-prev"><img src="assets/frontends/images/arrow-prev.png" alt="preview"></a>
            <i class="fs-current-index">1</i> of <i class="fs-current-total">1</i>
            <a href="single.html" class="fs-arrow-next swiper-next"><img src="assets/frontends/images/arrow-next.png" alt="preview"></a>
            </span>
            </div>
...
<a href="<?=$open_link?>">
<img src="<?=!empty($set_news->image)?'assets/uploads/news/full/'.$set_news->image:'assets/uploads/no-image.gif'?>" alt="portfolio image" style="">
</a>
