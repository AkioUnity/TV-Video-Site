            ...
            <div class="portlet-body">
                ...
                <div class="form-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-5">
                            <input class="form-control input-date" type="text" id="i-s-date" name="s_date"
                                   value="<?= h_dateFormat(set_value('s_date', $form_data->{'s_date'}), 'd-m-Y') ?>"
                                   data-date-format="dd-mm-yyyy" required/>
                            <span class="error-span"><?php echo form_error('s_date'); ?></span>
                        </div>

                        <div class="col-lg-5">
                            <input class="form-control input-date" type="text" id="i-e-date" name="e_date"
                                   value="<?= h_dateFormat(set_value('e_date', $form_data->{'e_date'}), 'd-m-Y') ?>"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-10">Password Protect Page?
                            <input type="checkbox" name="is_secure"
                                   value="1" <?= $form_data->is_secure == 1 ? 'checked="checked"' : '' ?>
                                   onclick="set_secure();" id="input-is_secure"/>

                            <div class="shipping-box">
                                <input type="text" name="page_password"
                                       value="<?= set_value('page_password', $form_data->page_password) ?>"
                                       placeholder="Set Password" class="form-control " required>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-10">
                            ...
                            if (!empty($form_data->video_file)) {
                                ...
                                <div class="" style="margin-left:-10px;margin-top:10px;">
                                    <div id="fileuploader" class="fileuploader" style="background-color:#268abe"><i
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-10">
                            <input type="text" name="publish_date"
                                   value="<?= set_value('publish_date', h_dateFormat($form_data->{'publish_date'}, 'd-m-Y')) ?>"
                                   id="input-date" class="form-control" required="required"
                                   data-date-format="dd-mm-yyyy"/>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-offset-2 col-md-9">
                            <button type="submit" class="btn btn-primary submitBtn"
                                    data-loading-text="<i class='fa fa-circle-o-notch fa-spin'></i> Save">Save
                            </button>
...
<script>
    function get_sub_category(id) {
        ...
        $.ajax({
            ...
            data: {id: id,<?=$this->security->get_csrf_token_name();?>:
    ...
    $('.cleditor2').summernote({
        ...
        callbacks: {
            onImageUpload: function (files, editor, welEditable) {
                $.blockUI({
                    message: '<img src="assets/uploads/loading1.gif" style="width:100px;height:100px;" />',
...
<script src="assets/plugins/jasny-bootstrap/js/jasny-bootstrap.min.js" type="text/javascript"
