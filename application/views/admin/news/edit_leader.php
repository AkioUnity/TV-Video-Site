...
<div class="form-group">
	<label class="col-lg-2 control-label">Title 2</label>
    <div class="col-lg-10">
...
<div class="form-group">
<label class="col-lg-2 control-label">Quote
<br> (for Front Page)
</label>
<div class="col-lg-10">
...
<div class="form-group">
<label class="col-lg-2 control-label">Article Text
<br> (for Article)
</label>
<div class="col-lg-10">
<?=form_textarea('description_2', html_entity_decode(set_value('description_2', $form_data->{'description_2'})), ' class="cleditor2 form-control"')?>
</div>
</div>
...
<div class="col-lg-10">
<input type="checkbox" name="is_home" value="1" <?=$form_data->is_home==1?'checked="checked"':''?> />
</div>
</div>

<div class="form-group">
<label class="col-lg-2 control-label">Show in presenters</label>
<div class="col-lg-10">
<input type="checkbox" name="is_presenter" value="1" <?=$form_data->is_presenter==1?'checked="checked"':''?> />
</div>
</div>
