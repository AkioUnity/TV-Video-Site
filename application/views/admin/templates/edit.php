...
<div id="editorContainer"></div>    
        <div class="portlet box green">
            ...
            <div class="portlet-body">
                ...
                <?=form_open(NULL, array('class' => 'form-horizontal edit-form', 'role'=>'form','enctype'=>"multipart/form-data"))?>                      <div id="more_pic" style="display:none"></div>
                        <div class="form-body">
...
function sendFile(file, editor, welEditable) {
    ...
    $.ajax ({
        ...
        success: function(url) {
			var pic_id = '<input type="hidden" name="more_pic[]" value="'+url+'" class="" />';
