  ...
  <div class="row">
            ...
            <span class="help">Shortcut to access your Channel directly</span>
              <div class="input-group transparent">
                <div class="input-group-prepend">
                  ...
                  <input type="text" name="channel_url" placeholder="john-smith" class="form-control" id="input-copy" required>
              </div>
    ...
    <div class="col-lg-6">  
      <div class="form-group">
        ...
        <input class="tagsinput custom-tag-input form-control" name="tags" type="text" value="" />
      </div>
<div class="form-group">
	<label>Complex Name</label>
	<input type="text" name="complex_name" value="" class="form-control" required/>
</div>
  ...
  <div class="row">
      ...
      <div class="form-group">
            ...
            <input type="text" name="payoff_desc" value="" class="form-control"  />
        </div>
    </div>
  </div>
  <div class="row">
    <div class="col-md-12">  
      <div class="form-group">
            ...
            <textarea class="form-control" name="short_description" id="" placeholder="We’re back with Naomi Findlay and her team on the Reno Show, where you will get proven tips, trending home inspirations, and professional advice for renovating and styling your home. This episode features a lot of tips for people who want a hint of the outdoor in their home. "></textarea>
        </div>
    </div>
  </div>
      ...
      <div class="form-group">    
          <label>About Your Channel</label>
            ...
            <div class="summernote-wrapper required">
                <textarea id="summernote" name="description" class="required">
                    Add article copy here. Embed code is permitted. <br/>
                </textarea>
          </div>
      </div>   
    </div>
...
<input type="file" name="image" id="input-image" required></span>
...
<input type="file" name="image_2"  id="input-image_2" required></span>
...
<input type="file" name="logo" id="input-logo" required></span>
...
<input type="file" name="subscribe_image" id="input-subscribe_image" required></span>
...
<label id="input-subscribe_image-error" class="error" for="input-subscribe_image"></label>
    ...
    <button type="submit" name="draft" class="btn btn-warning btn-cons btn-animated from-top fa fa-save submitBtn" value="set">
