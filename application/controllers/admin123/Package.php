...
class Package extends Admin_Controller{
	public $_table_names = 'packages';		//set table name
	public $_subView = 'admin/package/';	//set subview load 
	public $_redirect = '/package';			//set link with controller file name
    ...
    public function edit($id = NULL){
        ...
        if($this->form_validation->run() == TRUE){
			...
			$data['slug'] = url_title(strtolower($data['name']), 'dash', true);
//			printR($_POST);
            if($id == NULL){
