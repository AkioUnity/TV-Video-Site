<?php
class Channel_request extends Admin_Controller{
	public $_table_names = 'users_channels_request';		//set table name
	public $_subView = 'admin/channel_request/';	//set subview load 
	public $_redirect = '/channel_request';			//set link with controller file name
	...
	public function __construct(){
		...
		$this->data['permissions']	= array( 'channel' => 'Channel','shows'=>'Shows','users'=>'Users');
        $this->perPage = 20;
	}
