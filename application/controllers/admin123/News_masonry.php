<?php
class News_masonry extends Admin_Controller{
	public $_table_names = 'news';		//set table name
	public $_subView = 'admin/news/';	//set subview load 
	public $_redirect = '/news_masonry';			//set link with controller file name
	...
	public function __construct(){
		...
		$this->data['tab_active'] = 'Masonry Collage';
    ...
    public function index(){
        ...
        $this->data['all_data'] = $this->comman_model->get_by($this->_table_names,array('section'=>'Masonry Collage'),false);
    ...
    public function edit($id = NULL){
        ...
        if($this->form_validation->run() == TRUE){
            ...
            $data =array();
			$postArr = array('name','link','head_title','label','article_id','v_link','tags');
...
/*			$more_pic = $this->input->post('more_pic');
		...
		$this->data['subview'] = $this->_subView.'edit_masonry';
        $this->load->view('admin/_layout_main', $this->data);
	}
