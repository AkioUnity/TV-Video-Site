...
class Category extends Admin_Controller{
	public $_table_names = 'news_category';		//set table name
	public $_subView = 'admin/category/';	//set subview load 
	public $_redirect = '/category';			//set link with controller file name
	...
	public function __construct(){
        ...
        $this->load->model(array('backend/category_model'));
    ...
    public function order_ajax(){
        ...
        // Fetch all pages
        $this->data['pages'] = $this->category_model->get_nested();
    ...
    public function edit($id = NULL){
	    ...
	    if($id){
		    ...
		    //set a new one
            $this->data['form_data'] = $this->category_model->get_new();
        ...
        if($this->form_validation->run() == TRUE){
            $data =array();
			$postArr = array('name','link');//'parent_id'
        ...
        $this->data['pages_no_parents'] = $this->category_model->get_no_parents();
