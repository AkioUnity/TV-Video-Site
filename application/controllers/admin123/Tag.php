...
class Tag extends Admin_Controller{
	public $_table_names = 'news_tag';		//set table name
	public $_subView = 'admin/tag/';	//set subview load 
	public $_redirect = '/tag';			//set link with controller file name
	...
	public function __construct(){
        ...
        $this->load->model(array('backend/tag_model'));
    ...
    public function order_ajax(){
        ...
        // Fetch all pages
        $this->data['pages'] = $this->tag_model->get_nested();
    ...
    public function edit($id = NULL){
	    ...
	    if($id){
		    ...
		    //set a new one
            $this->data['form_data'] = $this->tag_model->get_new();
        }
        ...
        $this->data['pages_no_parents'] = $this->tag_model->get_no_parents();
