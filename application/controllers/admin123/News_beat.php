<?php
class News_beat extends Admin_Controller{
	public $_table_names = 'news';		//set table name
	public $_subView = 'admin/news/';	//set subview load 
	public $_redirect = '/news_beat';			//set link with controller file name
	...
	public function __construct(){
		...
		$this->data['tab_active'] = 'On The Beat';
    ...
    public function index(){
        ...
        $this->data['all_data'] = $this->comman_model->get_by($this->_table_names,array('section'=>'On The Beat'),false);

		//set lead view		
        $this->data['subview'] = $this->_subView.'index_beat';	
    ...
    public function edit($id = NULL){
	    ...
	    if($id){
            ...
            $this->data['form_data']->is_feature = '';
        ...
        if($this->form_validation->run() == TRUE){
            ...
            $data =array();
			$postArr = array('name','sponsor_link','link','author_id','description','code','is_feature','label','tags');
...
/*			$more_pic = $this->input->post('more_pic');
		...
		$this->data['subview'] = $this->_subView.'edit_beat';
        $this->load->view('admin/_layout_main', $this->data);
	}
