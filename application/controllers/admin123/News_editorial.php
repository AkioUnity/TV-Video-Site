<?php
class News_editorial extends Admin_Controller{
	public $_table_names = 'news';		//set table name
	public $_subView = 'admin/news/';	//set subview load 
	public $_redirect = '/news_editorial';			//set link with controller file name
	...
	public function __construct(){
		...
		$this->data['tab_active'] = 'Editorial';
    ...
    public function index(){
        ...
        $this->data['all_data'] = $this->comman_model->get_by($this->_table_names,array('section'=>'Editorial'),false);
    ...
    public function edit($id = NULL){
        ...
        if($this->form_validation->run() == TRUE){
            ...
            $data =array();
			$postArr = array('name','sponsor_link','link','author_id','description','code','label','tags');
...
/*	   	$this->db->order_by('name','asc');
		...
		$this->data['subview'] = $this->_subView.'edit_editorial';
        $this->load->view('admin/_layout_main', $this->data);
	}
